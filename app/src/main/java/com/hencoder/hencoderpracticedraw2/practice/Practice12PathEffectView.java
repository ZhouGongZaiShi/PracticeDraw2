...
public class Practice12PathEffectView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        PathEffect cornerPathEffect = new CornerPathEffect(5);
        ...
        path.lineTo(10,0);
        path.lineTo(20,20);
        PathDashPathEffect pathDashPathEffect = new PathDashPathEffect(path, 40, 0, PathDashPathEffect.Style.ROTATE);
