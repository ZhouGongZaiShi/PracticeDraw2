...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        BitmapShader bitmapShader2 = new BitmapShader(logoBitmap, Shader.TileMode.CLAMP, Shader.TileMode.MIRROR);


        PorterDuffXfermode porterDuffXfermode = new PorterDuffXfermode(PorterDuff.Mode.DST_IN);
        ComposeShader composeShader = new ComposeShader(bitmapShader, bitmapShader2, porterDuffXfermode);
