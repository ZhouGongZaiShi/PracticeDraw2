...
//        LinearGradient linearGradient = new LinearGradient(100, 100, 500, 500, Color.parseColor("#E91E63")
//                ,Color.parseColor("#2196F3"), Shader.TileMode.CLAMP);

        //使用十六进制表示颜色时吗，需要完整的 ARGB。
        LinearGradient linearGradient = new LinearGradient(100, 100, 500, 500, 0xFFE91E63
                ,0xFF2196F3, Shader.TileMode.CLAMP);
